...
const ContactForm = () => {
  ...
  const validate = () => {
    ...
    if (!formData.message) errors.message = "Mensagem é obrigatório";
    return errors;
  }
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      emailjs
        ...
        .catch((error) => {
          ...
          toast.error("Falha no envio da mensagem. Por favor tente novamente mais tarde.");
        })
        .finally(() => {
          setIsSending(false);
        })
  ...
  return (
    <div className="p-4 lg:w-3/4" id="contact">
      <Toaster/>
      <h2 className="my-8 text-center text-4xl font-semibold tracking-tighter">Entre em Contato</h2>
      <motion.form 
        initial={{ opacity: 0 }}
